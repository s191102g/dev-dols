...
exports.UnbanClientHandler = void 0;
...
const UnbanClientOutput_1 = require("./UnbanClientOutput");
let UnbanClientHandler = class UnbanClientHandler extends CommandHandler_1.CommandHandler {
    ...
    async handle(param) {
        ...
        const result = new UnbanClientOutput_1.UnbanClientOutput();
        result.setData(hasSuccess);
        return result;
    }
};
UnbanClientHandler = tslib_1.__decorate([
    (0, typedi_1.Service)(),
    tslib_1.__param(0, (0, typedi_1.Inject)("client.repository")),
    tslib_1.__metadata("design:paramtypes", [Object])
], UnbanClientHandler);
exports.UnbanClientHandler = UnbanClientHandler;
