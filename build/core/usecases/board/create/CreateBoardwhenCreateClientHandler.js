...
exports.CreateBoardWhenCreateClientHandler = void 0;
...
let CreateBoardWhenCreateClientHandler = class CreateBoardWhenCreateClientHandler extends CommandHandler_1.CommandHandler {
    constructor(_boardReposiory) {
        super();
        this._boardReposiory = _boardReposiory;
    }
    async handle(param, handleOption) {
...
CreateBoardWhenCreateClientHandler = tslib_1.__decorate([
    (0, typedi_1.Service)(),
    tslib_1.__param(0, (0, typedi_1.Inject)("board.repository")),
    tslib_1.__metadata("design:paramtypes", [Object])
], CreateBoardWhenCreateClientHandler);
exports.CreateBoardWhenCreateClientHandler = CreateBoardWhenCreateClientHandler;
